...
$pdf->ezText("\nColumn shading\n", 10);
$pdf->ezTable($data, array('type' => '', 'name' => ''), '', array('showHeadings' => 0, 'showBgCol' => 1, 'width' => 400, 'cols' => array(
                    'name' => array('bgcolor' => array(0.2, 0.2, 0.4)), 'type' => array('bgcolor' => array(0.4, 0.6, 0.6)),
                  ),
        ));
...
$pdf->ezTable($data, $cols, '', array('showHeadings' => 1, 'showBgCol' => 1, 'width' => 400,
        'shadeHeadingCol' => array(0.6, 0.6, 0.5), 'cols' => array(
                    'name' => array('bgcolor' => array(0.9, 0.9, 0.7)), 'type' => array('bgcolor' => array(0.6, 0.4, 0.2)),
                  ),
        ));
...
$pdf->ezTable($data, $cols, '', array('width' => 300,
         ...
         'shadeHeadingCol' => array(0.6, 0.6, 0.5), 'cols' => array('type' => array('justification' => 'right'), 'name' => array('width' => 100)),
         ));
