...
class Cezpdf extends Cpdf {
    ...
    /**
     * stores most of the page configuration parameters
     *
     * @var array
     */
    ...
    /**
     * this is the current vertical positon on the page of the writing point, very important
     *
     * @var float
     */
    var $y;
        ...
        switch ($status) {
            case '1' :
                if (isset ($this->ezPages[$pageNum])) {
                    ...
                    $this->ez['insertOptions'] = array (
                        'id' => $this->ezPages[$pageNum],
                        'pos' => $pos
                    );
                }
                break;
