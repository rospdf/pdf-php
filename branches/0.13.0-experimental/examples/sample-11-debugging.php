...
$pdf->DEBUG = Cpdf_Common::DEBUG_BBOX;

// DEBUG: used to draw the table border only
$pdf->DEBUG = Cpdf_Common::DEBUG_TABLE;

// DEBUG: used to draw the table and text border (PoC)
$pdf->DEBUG = Cpdf_Common::DEBUG_TABLE | Cpdf_Common::DEBUG_TEXT;

// DEBUG: Output error and warning messages into apache error log
$pdf->DEBUG = Cpdf_Common::DEBUG_MSG_ERR;

// DEBUG OUTPUT (PLAIN TEXT) - requires to set $pdf->Compression = 0
$pdf->DEBUG = Cpdf_Common::DEBUG_OUTPUT;

// DEBUG everything, except DEBUG_OUTPUT
$pdf->DEBUG =  (Cpdf_Common::DEBUG_ALL ^ Cpdf_Common::DEBUG_OUTPUT);
