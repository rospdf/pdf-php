...
$pdf = new Creport('a4','portrait','image',array('img'=>'images/bg.jpg'));
...
$pdf->ezText("PDF with Background image\n");
...
$pdf->ezText("Transparent PNG image here:");
$pdf->ezImage('images/test_alpha2.png',0,0,'none','center');
$pdf->ezNewPage();
$pdf->ezText("Second Page");
//$pdf->ezNewPage();
//$pdf->ezText("Third Page");
